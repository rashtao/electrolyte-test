...
before(function () {
	IoC.singleton("singleton/service1", require("../../injectables/annotated/singleton/service1"));
	IoC.singleton("singleton/service2", require("../../injectables/annotated/singleton/service2"));
	IoC.singleton("singleton/service3", require("../../injectables/annotated/singleton/service3"), ["singleton/service2"]);
});
