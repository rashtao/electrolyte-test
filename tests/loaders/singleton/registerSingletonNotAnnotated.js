...
before(function () {
	IoC.register("singleton/service1", require("../../injectables/not_annotated/singleton/service1"), "@singleton");
	IoC.register("singleton/service3", require("../../injectables/not_annotated/singleton/service3"), ["singleton/service1"], "@singleton");
});

describe('registerSingletonNotAnnotated', function () {
